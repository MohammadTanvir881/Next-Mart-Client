...
export default function CartProductCard({ product }: { product: cartProduct }) {
  ...
  const handleIncremenrQuantity = (id: string) => {
    dispatch(incrementOrderQuantity(id));
  };
  const handleDecremenrQuantity = (id: string) => {
      ...
      <div className="flex flex-col justify-between flex-grow">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              onClick={() => handleDecremenrQuantity(product._id)}
              variant="outline"
            ...
            <Button
              onClick={() => handleIncremenrQuantity(product._id)}
              variant="outline"
              className="size-8 rounded-sm"
            >
              <Plus />
